        ...
        <div className={styles.iconsContainer}>
          <div className={styles.tiktok_instagram}>
            ...
            <a
              ...
              rel="noopener noreferrer"
            >
              <InstagramIcon className={styles.icons} sx={{ fontSize: 45 }} />@<p>ivanyaz</p>
            </a>
          </div>
          <div className={styles.facebook_telegram}>
            <a
              ...
              rel="noopener noreferrer"
            >
              <FacebookIcon className={styles.icons} sx={{ fontSize: 45 }} />
            ...
            <a
              ...
              rel="noopener noreferrer"
            >
              <TelegramIcon className={styles.icons} sx={{ fontSize: 45 }} />
